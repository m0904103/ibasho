...
document.addEventListener('DOMContentLoaded', () => {
  ...
  audio.addEventListener('timeupdate', () => {
    if (audio.duration) {
      ...
      // Precise thresholds calculated from audio script character pacing (11 slides)
      let targetSlideIndex = 0;
      if (percent >= 0.93) targetSlideIndex = 10;
      else if (percent >= 0.87) targetSlideIndex = 9;
      else if (percent >= 0.80) targetSlideIndex = 8;
      else if (percent >= 0.76) targetSlideIndex = 7;
      else if (percent >= 0.71) targetSlideIndex = 6;
      else if (percent >= 0.64) targetSlideIndex = 5;
